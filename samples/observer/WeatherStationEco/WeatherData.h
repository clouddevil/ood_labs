...
class CDisplayMeasurements: public IObserver<SWeatherInfo>
{
private:
...
class CDisplayWind : public IObserver<SWeatherInfo>
{
private:
	void Update(SWeatherInfo const& data) override
	{		
...
static constexpr int WIND_CHANGE_EVENT_ID = 1;
static constexpr int MEASUREMENTS_CHANGE_EVENT_ID = 2;
